namespace Library.Application.DTO
{
    public class BorrowedDto
    {
        ...
        public BorrowedDto(int id, int readerId, int bookId, DateTime issuedDate, DateTime dueDate, DateTime? dateReturned, bool borrowedStatus, int daysOfDelay, decimal overdueFine, bool isCharged)
        {
